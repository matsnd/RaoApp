...
CREATE TABLE IF NOT EXISTS `archive_contracts` (
  ...
  `invoice_document` varchar(40) DEFAULT NULL,
...
INSERT IGNORE INTO `archive_contracts`
  (id, contractor_id, branch_id, salesperson_id, number, oid, auto_number, contract_type,
   ...
   date_from, date_to, prepayment_amount, prepayment_document, invoice_amount,
   invoice_document, notes, contact_person1, contact_phone1, show_person1,
...
SELECT id, contractor_id, branch_id, salesperson_id, number, oid, auto_number,
       ...
       invoice_amount, invoice_document, notes, contact_person1, contact_phone1,
