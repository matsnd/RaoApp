...
MASZYNY = [
    # ── Ładowarki teleskopowe proste (4 szt) ─────────────────────────────────────
    {
        ...
        "category_sub2": "Ładowarka teleskopowa 6 m",
    ...
    },
    {
        ...
        "category_main": "Ładowarki teleskopowe", "category_sub1": "Ładowarki teleskopowe proste",
        "category_sub2": "Ładowarka teleskopowa 9 m",
    ...
    },
    {
        ...
        "category_main": "Ładowarki teleskopowe", "category_sub1": "Ładowarki teleskopowe proste",
        "category_sub2": "Ładowarka teleskopowa 12 m",
    ...
    },
    {
        ...
        "category_main": "Ładowarki teleskopowe", "category_sub1": "Ładowarki teleskopowe proste",
        "category_sub2": "Ładowarka teleskopowa 18 m",
    ...
    # ── Ładowarki teleskopowe obrotowe (3 szt) ───────────────────────────────────
    {
        ...
        "category_sub2": "Ładowarka teleskopowa obrotowa 14 m",
    ...
    },
    {
        ...
        "category_main": "Ładowarki teleskopowe", "category_sub1": "Ładowarki teleskopowe obrotowe",
        "category_sub2": "Ładowarka teleskopowa obrotowa 20 m",
    ...
    },
    {
        ...
        "category_main": "Ładowarki teleskopowe", "category_sub1": "Ładowarki teleskopowe obrotowe",
        "category_sub2": "Ładowarka teleskopowa obrotowa 26 m",
    ...
    # ── Podnośniki nożycowe elektryczne (3 szt) ──────────────────────────────────
    {
        ...
        "category_sub2": "Podnośnik nożycowy elektryczny 8 m",
        "reach_m": Decimal("8.0"),
    ...
    },
    {
        ...
        "category_main": "Podnośniki", "category_sub1": "Podnośniki nożycowe elektryczne",
        "category_sub2": "Podnośnik nożycowy elektryczny 12 m",
    ...
    },
    {
        ...
        "category_main": "Podnośniki", "category_sub1": "Podnośniki nożycowe elektryczne",
        "category_sub2": "Podnośnik nożycowy elektryczny 18 m",
    ...
    # ── Podnośniki przegubowo-teleskopowe elektryczne (2 szt) ────────────────────
    {
        ...
        "category_sub2": "Podnośnik przegubowo-teleskopowy elektryczny 12 m",
        "reach_m": Decimal("12.0"),
    ...
    },
    {
        ...
        "category_main": "Podnośniki", "category_sub1": "Podnośniki przegubowo-teleskopowe elektryczne",
        "category_sub2": "Podnośnik przegubowo-teleskopowy elektryczny 22 m",
    ...
    # ── Podnośniki teleskopowe spalinowe (2 szt) ─────────────────────────────────
    {
        ...
        "category_sub2": "Podnośnik teleskopowy spalinowy 18 m",
    ...
    },
    {
        ...
        "category_main": "Podnośniki", "category_sub1": "Podnośniki teleskopowe spalinowe",
        "category_sub2": "Podnośnik teleskopowy spalinowy 22 m",
    ...
    # ── Podnośniki gąsienicowe (1 szt) ───────────────────────────────────────────
    {
        ...
        "category_sub2": "Podnośnik gąsienicowy 22 m",
        "reach_m": Decimal("22.0"),
    ...
    # ── Podnośniki przyczepowe (1 szt) ───────────────────────────────────────────
    {
        ...
        "category_sub2": "Podnośnik przyczepowy 15 m",
    ...
    # ── Wózki widłowe elektryczne (2 szt) ────────────────────────────────────────
    {
        ...
        "category_sub2": "Wózek widłowy elektryczny 2,5t",
    ...
    },
    {
        ...
        "category_main": "Wózki widłowe", "category_sub1": "Wózki widłowe elektryczne",
        "category_sub2": "Wózek widłowy elektryczny 5t",
    ...
    # ── Wózki widłowe Diesel (2 szt) ─────────────────────────────────────────────
    {
        ...
        "category_sub2": "Wózek widłowy Diesel 3t",
    ...
    },
    {
        ...
        "category_main": "Wózki widłowe", "category_sub1": "Wózki widłowe Diesel",
        "category_sub2": "Wózek widłowy Diesel 8t",
    ...
    },
    {
        ...
        "category_main": "Akcesoria", "category_sub1": None,
        "category_sub2": "Wciągarka typu żuraw",
    ...
    },
    {
        ...
        "category_main": "Akcesoria", "category_sub1": None,
        "category_sub2": "Przedłużenie wideł",
    ...
    # ── Dodatkowe kategorie (zachowane — spychacz + zagęszczarka) ────────────────
    {
        ...
        "category_sub2": "Spychar frezujący",
    ...
    },
    {
        ...
        "category_sub2": "Zagęszczarka płytowa",
...
def _build_positions_and_fees(i, days, maszyny, uslugi, rt_dniowy, contract_type="S", uslugi_zwykle=None):
    ...
    DEMO_FEE_DESCRIPTION = {
        ...
        "Usługa tankowania": "$1 (plus koszt paliwa)",
        "Ponadnormatywny przestój transportu": "$1 / h - $2 / h",
        "Nieuzasadnione wezwanie serwisowe": "$1 (plus transport)",
        "Przegląd techniczny i czyszczenie maszyny": "$1",
        "Przegląd techniczny, ładowanie akumulatorów oraz czyszczenie maszyny": "$1",
    }
    fees = []
    # P1-120: Umowy najmu (S) = pełny zestaw 6 opłat (jak z uwag klienta)
    # Umowy usługi (U) = brak opłat dodatkowych
    if contract_type == "S":
        # Dict po name dla łatwego wyszukiwania (name = pełna nazwa)
        ...
        przeglad_name = "Przegląd techniczny i czyszczenie maszyny" if power_type == 'diesel' else "Przegląd techniczny, ładowanie akumulatorów oraz czyszczenie maszyny"
        ...
        fee_specs = [
            ...
            ("Czyszczenie maszyny (zabrudzenia ponadnormatywne)", None,             None),                # wycena indywidualna
            ("Usługa tankowania",                               Decimal("200.00"),  None),                # +koszt paliwa
            ("Ponadnormatywny przestój transportu",             Decimal("200.00"),  Decimal("300.00")),   # widełki /h
            ("Nieuzasadnione wezwanie serwisowe",               Decimal("280.00"),  None),                # +transport
        ]
...
ZESTAWY_USLUG = [
    {
        ...
        "templates": [
            ...
            {"article": "Przegląd techniczny i czyszczenie maszyny", "name": "Przegląd techniczny i czyszczenie maszyny", "amount_from": Decimal("150.00"), "amount_to": None, "unit": "sztuka", "description": "$1"},
            ...
            {"article": "Nieuzasadnione wezwanie serwisowe", "name": "Nieuzasadnione wezwanie serwisowe", "amount_from": Decimal("280.00"), "amount_to": None, "unit": "wizyta", "description": "$1 (plus transport)"},
        ],
    },
    {
