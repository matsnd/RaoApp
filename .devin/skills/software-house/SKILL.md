...
3. Wiedza: wzorce → `spec/technical/patterns/`, skrypty → `scripts/` (kanoniczna lokalizacja dla wszystkich helper Python: ops, debug, verify, seed, migrate), indeks `TECHNICAL_SOLUTIONS.md`.
