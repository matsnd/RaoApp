  ...
  <div style="display:flex;flex-direction:column;height:100vh;overflow:hidden;">
    ...
    <div class="content-area">
      ...
      <div v-else class="page-card" style="max-width:800px;">
        ...
        <div class="form-row-2">
          <div class="form-group">
            <label class="form-label" for="service-cat-main">Kategoria</label>
            <div style="display:flex;flex-direction:column;gap:4px;">
              <select id="service-cat-main" v-model="catSelectedMain" class="form-control" @change="catSelectedSub1 = null; catSelectedSub2 = null">
          ...
          <div class="form-group">
            <label class="form-label" for="service-branch">Filia</label>
            <select id="service-branch" v-model="form.branch_id" class="form-control">
