...
- `scripts/migrate_service_fees.py` — `_find_or_create_service_article` → `_find_or_create_additional_service`
...
- `scripts/export_to_unify.py` — export z 3 tabel
...
- `scripts/seed_fa_invoices.py` — `get_article_fa_product_map` → mapping z 3 tabel
...
- `scripts/seed_demo_data.py` — pełna przebudowa:
...
- `scripts/seed_fa_invoices.py` — `get_article_fa_product_map` → mapping z 3 tabel
- `scripts/migrate_service_fees.py` — `_find_or_create_service_article` → `_find_or_create_additional_service`
- `scripts/archive_legacy_data.py` — update jeśli używa articles (archive zostaje, ale skrypt może referencjonować articles dla source)
